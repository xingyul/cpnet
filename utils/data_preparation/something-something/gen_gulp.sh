...
python3 -m gulpio.GulpAdapter \
    ...
    --output_path /datasets/something-something/gulp_256/val \
    --num_workers 4 \
    --frame_size 256 \
    --frame_rate 24 \
    --skip_exist
...
python3 -m gulpio.GulpAdapter \
    ...
    --output_path /datasets/something-something/gulp_256/train \
    --num_workers 4 \
    --frame_size 256 \
    --frame_rate 24 \
    --skip_exist
...
python3 -m gulpio.GulpAdapter \
    ...
    --output_path /datasets/something-something/gulp_256/test \
    --num_workers 4 \
    --frame_size 256 \
    --frame_rate 24 \
    --skip_exist
